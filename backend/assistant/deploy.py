#!/usr/bin/env python3
"""
Deploy legal assistant service to AWS App Runner
...
def main():
    print("Legal Assistant Service - Docker Deployment")
    print("===========================================")
    ...
    ecr_repository = "legal-assistant"
    ...
    terraform_dir = Path(__file__).parent.parent.parent / "terraform" / "assistant"
    ...
    print(
        "\nNext step: Run 'terraform apply' in terraform/assistant to create the App Runner service."
    )
    ...
    try:
        services = run_command(
            [
                ...
                region,
                "--query",
                "ServiceSummaryList[?ServiceName=='legal-assistant'].ServiceArn",
                "--output",
                "json",
            ],
            capture_output=True,
        ...
        if services:
            ...
            if service_arns:
                                ...
                                "ImageRepository": {
                                    ...
                                    "ImageConfiguration": {
                                        ...
                                        "RuntimeEnvironmentVariables": {
                                            ...
                                            "COUNSEL_API_KEY": os.environ.get("COUNSEL_API_KEY", ""),
                                            "COUNSEL_API_ENDPOINT": os.environ.get("COUNSEL_API_ENDPOINT", ""),
                ...
                print("  2. Select 'legal-assistant' service")
