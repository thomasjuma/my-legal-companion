...
def main():
    ...
    print("=" * 60)
    print("Legal Counsel S3 Vectors Database Explorer")
    print("=" * 60)
    ...
    search_queries = [
        "breach of contract and remedies for non-performance",
        "negligence duty of care and standard of reasonable care",
        "intellectual property infringement and fair use defenses",
        "employment discrimination and wrongful termination claims",
        "data privacy obligations and consent under applicable law",
    ]
